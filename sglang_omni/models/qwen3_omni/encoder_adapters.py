...
in the SGLang TP path — wiring cache into a TP-broadcasting scheduler
requires shipping the hit/miss decision before the device broadcast.
The local backend keeps its cache; the SGLang backend always forwards
every non-skip request.
"""
