...
def create_sglang_qwen3_asr_executor(
    ...
    *,
    ...
    return Qwen3ASREngineBuilder(
        ...
        pre_lm_cache_deferred_copy=pre_lm_cache_deferred_copy,
        pre_lm_cache_pending_max_entries=pre_lm_cache_pending_max_entries,
        pre_lm_cache_pending_max_bytes=pre_lm_cache_pending_max_bytes,
